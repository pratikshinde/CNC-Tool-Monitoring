...
/* board.h references I2C_NUM_0/I2C_NUM_1 — one port per SMU
 * (FIRMWARE_DESIGN_SPEC.md §5.1). Real ESP-IDF cross-compiles never
 * exercise this stub (they see the real i2c_port_t), so this file is the
 * only place a V2 migration change to board.h's I2C constants gets
 * checked before it reaches host_test. */
#define I2C_NUM_0 0
#define I2C_NUM_1 1
